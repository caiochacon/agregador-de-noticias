...
dataset = pd.read_csv("/home/vinicius_olzon/Documents/ENG_SOFTWARE/backend/flask_app/agregador_de_noticias_recommendation_system/dataset/notices_small.csv", low_memory=False, encoding="UTF-8")
